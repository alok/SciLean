...
by
  funext
  simp [modifyThe, MonadStateOf.modifyGet, StateT.modifyGet, fwdFDerivM, bind, Bind.bind,
    StateT.bind]
  fun_trans; congr
...
by
  funext
  simp [getThe, MonadStateOf.get, StateT.get, revFDerivValM, revFDerivM, pure, StateT.pure, bind,
    StateT.bind, modifyThe, MonadStateOf.modifyGet]
  fun_trans; rfl
...
by
  funext
  simp [MonadState.get, getThe, MonadStateOf.get, StateT.get, revFDerivValM, revFDerivM, pure,
    StateT.pure, bind, StateT.bind, modify, MonadStateOf.modifyGet, modifyGet]
  fun_trans; rfl
...
by
  funext
  simp [set, StateT.set, revFDerivM, getThe, MonadStateOf.get, bind, StateT.bind, pure, StateT.pure,
    get]
